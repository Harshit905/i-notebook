  ...
  return (
    <form onSubmit={handleSubmit}>
      <div class="login1">
        ...
        <input type="email" value={credentials.email} onChange={onChange} placeholder="Enter your Email ID" class="login" name="email" id="email" autoFocus required /><br /><br />
        ...
        <p className='p_login'>New Here? <a href='#' >Sign Up</a></p>
      </div>
    </form>
  )
}
